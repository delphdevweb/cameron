...
--
-- Hôte : localhost:3306
-- Généré le : ven. 02 avr. 2021 à 15:20
...
--
-- Structure de la table `assoc_styles_artists`
--

CREATE TABLE `assoc_styles_artists` (
  `assoc_id` int NOT NULL,
  `assoc_artists_id` int NOT NULL,
  `assoc_styles_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Déchargement des données de la table `assoc_styles_artists`
--

INSERT INTO `assoc_styles_artists` (`assoc_id`, `assoc_artists_id`, `assoc_styles_id`) VALUES
(1, 1, 1),
(2, 2, 2),
(3, 1, 3),
(4, 3, 4),
...
--
-- Index pour la table `assoc_styles_artists`
--
ALTER TABLE `assoc_styles_artists`
  ADD PRIMARY KEY (`assoc_id`),
  ADD KEY `assoc_artists_id` (`assoc_artists_id`),
  ADD KEY `assoc_styles_id` (`assoc_styles_id`);
...
--
ALTER TABLE `artists`
  MODIFY `artist_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT pour la table `assoc_styles_artists`
--
ALTER TABLE `assoc_styles_artists`
  MODIFY `assoc_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `styles`
  MODIFY `style_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=619;
...
--
-- Contraintes pour la table `assoc_styles_artists`
--
ALTER TABLE `assoc_styles_artists`
  ADD CONSTRAINT `assoc_styles_artists_ibfk_1` FOREIGN KEY (`assoc_styles_id`) REFERENCES `styles` (`style_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `assoc_styles_artists_ibfk_2` FOREIGN KEY (`assoc_artists_id`) REFERENCES `artists` (`artist_id`) ON DELETE CASCADE ON UPDATE CASCADE;
